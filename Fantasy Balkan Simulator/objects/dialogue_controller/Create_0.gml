...
[
	...
	["NotCompleted","Kondor: Those..! Those are my Jewels ! You found them for me ? How generous of you..Mr slime ? anyways I can't think of how to reward you… Kondor: Actually here's this metal detector.. it’s not much but if you find me some materials I can craft you anything you'd like!", "Jewels"],
	["NotCompleted","Kondor: Hmm this doesn’t seem enough for a sword.. How about an axe ? can never go wrong with an axe Kondor : What to do with it ? I don’t know ? defend yourself maybe ? maybe cut down some trees in the forest ? ","Scrap Iron"],
