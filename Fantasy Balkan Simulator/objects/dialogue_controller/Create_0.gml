...
npc_counter = [0, 4, 0, 0, 0];
npc_counter_max = [3, 8, 0, 0, 0];
...
[
	...
	["NotCompleted","Kondor: What to do with it ? I don't know ? defend yourself maybe ? maybe cut down some trees in the forest ? ",[]],
